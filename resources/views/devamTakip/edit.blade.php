    ...
    <div class="card">
        ...
        <div class="card-body pt-0">
            <div class="card-columns">
                <div class="col">
                    <div class="card p-2"><p class="card-text"><b>Sınıfın Adı:</b> {{$devamTakip->sinif->name}}</p>
                    </div>
                </div>
                <div class="col">
                ...
                <div class="col">
                    <div class="card p-2"><p class="card-text"><b>Ders Öğretmeni:</b> {{$devamTakip->user->name}}</p>
                    </div>
                </div>
                <div class="col">
                    <div class="card p-2">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex w-auto justify-content-between">
                                            ...
                                            <span>
                                                    ...
                                                    <a href="{{route('devamtakip.edit',$item->id)}}"
                                                       class="btn btn-sm {{$item->devam?"btn-success":"btn-danger"}}"><i
