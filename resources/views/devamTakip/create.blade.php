<x-app-layout>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{route('devamtakip.store')}}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" name="date" class="form-control" value="{{ old('ders_tarih') }}">
                </div>
                <div class="form-group">
                    <label>Ders Saati</label>
                    <select name="hour" class="form-control select2">
